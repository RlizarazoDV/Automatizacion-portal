...
public class Certificacion_De_Pagos extends basePage{
    ...
    private final By linkCertificacionPagos = By.xpath("//*[contains(text(),'Certificación de Pagos')]");
    ...
    public Certificacion_De_Pagos(WebDriver webDriver) {
        super(webDriver);
    ...
    public void Certificacion_De_Pagos() {
        WebElement opcionCPagos = waitP.until(ExpectedConditions.visibilityOfElementLocated(linkCertificacionPagos));
        opcionCPagos.click();
