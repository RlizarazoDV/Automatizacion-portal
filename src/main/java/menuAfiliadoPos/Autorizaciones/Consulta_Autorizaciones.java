...
public class Consulta_Autorizaciones  extends basePage{
    ...
    private final By linkInformacionA= By.linkText("Consultar Autorizaciones");
    private final By iFrame  = By.xpath("//*[contains(@id,'ifAuto')]");

    public Consulta_Autorizaciones(WebDriver webDriver) {
        super(webDriver);
