...
public class Pagos extends basePage {
    ...
    private final By linkPagos= By.xpath("//*[@id='option363']/table/tbody/tr[3]/td[2]/p/a");
    ...
    public Pagos(WebDriver webDriver) {
        super(webDriver);
    ...
    public void Pagos() {
        WebElement opcionCPagos = waitP.until(ExpectedConditions.visibilityOfElementLocated(linkPagos));
        opcionCPagos.click();
