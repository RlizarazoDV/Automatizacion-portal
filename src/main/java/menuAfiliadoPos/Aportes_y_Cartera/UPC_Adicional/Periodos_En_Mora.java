...
public class Periodos_En_Mora extends basePage {
    ...
    private final By linkPMore = By.xpath("//*[contains(text(),'Periodos en Mora')]");
    private final By respuesta = By.xpath("//*[contains(text(),'No hay resultados para mostrar')]");


    public Periodos_En_Mora(WebDriver webDriver) {
        super(webDriver);
    ...
    public void ingreso_Periodos_mora() {
        WebElement Periodos_Mora = waitMensaje.until(ExpectedConditions.presenceOfElementLocated(linkPMore));
        Periodos_Mora.click();
    }
