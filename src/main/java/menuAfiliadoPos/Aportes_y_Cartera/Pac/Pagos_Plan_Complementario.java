package menuAfiliadoPos.Aportes_y_Cartera.Pac;
...
public class Pagos_Plan_Complementario extends basePage {
    ...
    private final By linkPac = By.xpath("//*[@id=\"option24\"]/table/tbody/tr[5]/td[2]/div/p");
    ...
    public String ingreso_Pagos_Plan_Complementario() {
        ...
        try {
            ...
            // No se detectó el error de redirección; verifica la URL correcta
            if (webDriver.getCurrentUrl().contains("d_eCollectPlus/CommerceMessage.aspx")) {
