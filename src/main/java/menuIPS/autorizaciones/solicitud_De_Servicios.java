...
public class solicitud_De_Servicios extends basePage {
    ...
    private final By linkSolicitudServicios= By.linkText("Solicitud de Servicios");
    ...
    public void Solicitud_De_Servicios(){
        WebElement opcionSolicitudDeServicios = waitP.until(ExpectedConditions.visibilityOfElementLocated(linkSolicitudServicios));
        opcionSolicitudDeServicios.click();
