...
public class Radicaciones_BackOffice extends basePage {
    ...
    private final By RadicacionesBack = By.linkText("Radicaciones al BackOffice");


    private final By iFrame  = By.xpath("//*[contains(@id,'ifAuto')]");

    public Radicaciones_BackOffice(WebDriver webDriver) {
        super(webDriver);
    ...
    public void ingreso_Radicaciones_BackOffice(){
        WebElement linkRadicacionesBack = wait.until(ExpectedConditions.elementToBeClickable(RadicacionesBack));
        linkRadicacionesBack.click();
