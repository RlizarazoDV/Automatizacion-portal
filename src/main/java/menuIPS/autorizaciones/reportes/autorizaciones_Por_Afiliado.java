...
public class autorizaciones_Por_Afiliado extends basePage {
    ...
    private final By AuthAfiliado = By.linkText("Autorizaciones por Afiliado");


    private final By iFrame  = By.xpath("//*[contains(@id,'ifWindows')]");

    public autorizaciones_Por_Afiliado(WebDriver webDriver) {
        super(webDriver);
    ...
    public void ingreso_Autorizaciones_Por_Afiliado(){
        WebElement linkAuthAfi = wait.until(ExpectedConditions.elementToBeClickable(AuthAfiliado));
        linkAuthAfi.click();
