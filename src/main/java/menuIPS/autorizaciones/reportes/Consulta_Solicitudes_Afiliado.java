...
public class Consulta_Solicitudes_Afiliado extends basePage {
    ...
    private final By ConsultaSolicitudes = By.linkText("Consulta Solicitudes Afiliado");


    private final By iFrame  = By.xpath("//*[contains(@id,'ifAuto')]");

    public Consulta_Solicitudes_Afiliado(WebDriver webDriver) {
        super(webDriver);
    ...
    public void ingreso_Consulta_Solicitudes_Afiliado(){
        WebElement linkConsulta = wait.until(ExpectedConditions.elementToBeClickable(ConsultaSolicitudes));
        linkConsulta.click();
