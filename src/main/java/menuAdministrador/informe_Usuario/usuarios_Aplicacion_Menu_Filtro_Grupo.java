...
public class usuarios_Aplicacion_Menu_Filtro_Grupo extends basePage {
    ...
    private final By linkUsuarioPorAplicacionPorMenuPorFiltro= By.linkText("Usuarios por Aplicación por Menú por Filtro por Grupo");
    ...
    private final By linkFitro = By.xpath("//*[contains(text(),'Filtro:')]//following::select[1]");
    private final By linkbotonAceptar = By.xpath("//input[contains(@class,'iceCmdBtn')and contains(@src, '/Portal/imgs/btnAceptar.gif')]");
    private final By aplicacionAdmin = By.xpath("//*[contains(@class,'iceOutTxt')and contains(@id,'data:2')]");
    ...
    public usuarios_Aplicacion_Menu_Filtro_Grupo(WebDriver webDriver) {
        super(webDriver);
    ...
    public void escogeAplicacion(String aplicacion,String menu,String filtro) {
        ...
        Select opcionfiltro = new Select(waitP.until(ExpectedConditions.elementToBeClickable(linkFitro)));
        opcionfiltro.selectByVisibleText(filtro);
