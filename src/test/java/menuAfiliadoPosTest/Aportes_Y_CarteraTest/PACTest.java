...
import menuAfiliadoPos.Aportes_y_Cartera.Pac.Pagos_Plan_Complementario;
...
public class PACTest extends baseTest {
    ...
    public void setUp(String rutaArchivo, String nombreHoja) {
        ...
        parentTest = extent.createTest("Afiliado POS - PAC");
        parentTest.info("Iniciando pruebas de PAC.");
    }
